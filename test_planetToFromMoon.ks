...
//TODO timewarp causes rapod switching between connected and disconnected.
//UNUSED SOLUTION: add arg to mastercompile to disable archiving if stuff has already been dounloaded
//USES solution: wait until timewarp = 0;